...
Namespace Sample
	...
	Partial Public Class NorthwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddProductsRow(ByVal ProductName As String, ByVal SupplierID As Integer, ByVal parentCategoriesRowByFK_Products_Categories As CategoriesRow, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal ReorderLevel As Short, ByVal Discontinued As Boolean) As ProductsRow
	...
	End Class
End Namespace
Namespace Sample.NorthwindDataSetTableAdapters
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categories] ([CategoryName], [Description], [Picture]) VALUES " & "(@CategoryName, @Description, @Picture);" & Constants.vbCrLf & "SELECT CategoryID, CategoryName, Descr" & "iption, Picture FROM Categories WHERE (CategoryID = SCOPE_IDENTITY())"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Categories] SET [CategoryName] = @CategoryName, [Description] = @Description, [Picture] = @Picture WHERE (([CategoryID] = @Original_CategoryID) AND ([CategoryName] = @Original_CategoryName));" & ControlChars.CrLf & "SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)"
		...
		Private Sub InitConnection()
			...
			Me._connection.ConnectionString = My.Settings.Default.NorthwindConnectionString1
		End Sub
		...
		Public Overridable Function Update(ByVal CategoryName As String, ByVal Description As String, ByVal Picture() As Byte, ByVal Original_CategoryID As Integer, ByVal Original_CategoryName As String, ByVal CategoryID As Integer) As Integer
			If (CategoryName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("CategoryName")
			Else
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt(Fix(CategoryID)))
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
			Me._adapter.InsertCommand.Connection = Me.Connection
			Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [SupplierID], [CategoryID], [QuantityPerUnit], [UnitPrice], [UnitsInStock], [UnitsOnOrder], [ReorderLevel], [Discontinued]) VALUES (@ProductName, @SupplierID, @CategoryID, @QuantityPerUnit, @UnitPrice, @UnitsInStock, @UnitsOnOrder, @ReorderLevel, @Discontinued);" & ControlChars.CrLf & "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = SCOPE_IDENTITY())"
			Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
			...
			Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
			Me._adapter.UpdateCommand.Connection = Me.Connection
			Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [SupplierID] = @SupplierID, [CategoryID] = @CategoryID, [QuantityPerUnit] = @QuantityPerUnit, [UnitPrice] = @UnitPrice, [UnitsInStock] = @UnitsInStock, [UnitsOnOrder] = @UnitsOnOrder, [ReorderLevel] = @ReorderLevel, [Discontinued] = @Discontinued WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_SupplierID = 1 AND [SupplierID] IS NULL) OR ([SupplierID] = @Original_SupplierID)) AND ((@IsNull_CategoryID = 1 AND [CategoryID] IS NULL) OR ([CategoryID] = @Original_CategoryID)) AND ((@IsNull_QuantityPerUnit = 1 AND [QuantityPerUnit] IS NULL) OR ([QuantityPerUnit] = @Original_QuantityPerUnit)) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original_UnitPrice)) AND ((@IsNull_UnitsInStock = 1 AND [UnitsInStock] IS NULL) OR ([UnitsInStock] = @Original_UnitsInStock)) AND ((@IsNull_UnitsOnOrder = 1 AND [UnitsOnOrder] IS NULL) OR ([UnitsOnOrder] = @Original_UnitsOnOrder)) AND ((@IsNull_ReorderLevel = 1 AND [ReorderLevel] IS NULL) OR ([ReorderLevel] = @Original_ReorderLevel)) AND ([Discontinued] = @Original_Discontinued));" & ControlChars.CrLf & "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)"
			Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" & ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
		...
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID? As Integer, ByVal Original_CategoryID? As Integer, ByVal Original_QuantityPerUnit As String, ByVal Original_UnitPrice? As Decimal, ByVal Original_UnitsInStock? As Short, ByVal Original_UnitsOnOrder? As Short, ByVal Original_ReorderLevel? As Short, ByVal Original_Discontinued As Boolean) As Integer
			...
			If (Original_SupplierID.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(3).Value = (CInt(Fix(Original_SupplierID.Value)))
			Else
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(5).Value = (CInt(Fix(Original_CategoryID.Value)))
			Else
			...
			If (Original_UnitsInStock.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(11).Value = (CShort(Fix(Original_UnitsInStock.Value)))
			Else
			...
			If (Original_UnitsOnOrder.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(13).Value = (CShort(Fix(Original_UnitsOnOrder.Value)))
			Else
			...
			If (Original_ReorderLevel.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(15).Value = (CShort(Fix(Original_ReorderLevel.Value)))
			Else
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
		Public Overridable Function Update(ByVal ProductName As String, ByVal SupplierID? As Integer, ByVal CategoryID? As Integer, ByVal QuantityPerUnit As String, ByVal UnitPrice? As Decimal, ByVal UnitsInStock? As Short, ByVal UnitsOnOrder? As Short, ByVal ReorderLevel? As Short, ByVal Discontinued As Boolean, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID? As Integer, ByVal Original_CategoryID? As Integer, ByVal Original_QuantityPerUnit As String, ByVal Original_UnitPrice? As Decimal, ByVal Original_UnitsInStock? As Short, ByVal Original_UnitsOnOrder? As Short, ByVal Original_ReorderLevel? As Short, ByVal Original_Discontinued As Boolean, ByVal ProductID As Integer) As Integer
			If (ProductName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("ProductName")
			Else
			...
			Me.Adapter.UpdateCommand.Parameters(9).Value = (CInt(Fix(Original_ProductID)))
			If (Original_ProductName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("Original_ProductName")
			Else
				Me.Adapter.UpdateCommand.Parameters(10).Value = (CStr(Original_ProductName))
			End If
			If (Original_SupplierID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(11).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CInt(Fix(Original_SupplierID.Value)))
			Else
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(14).Value = (CInt(Fix(Original_CategoryID.Value)))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(16).Value = (CStr(Original_QuantityPerUnit))
			End If
			If (Original_UnitPrice.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(17).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(18).Value = (CDec(Original_UnitPrice.Value))
			Else
			...
			If (Original_UnitsInStock.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(20).Value = (CShort(Fix(Original_UnitsInStock.Value)))
			Else
			...
			If (Original_UnitsOnOrder.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(22).Value = (CShort(Fix(Original_UnitsOnOrder.Value)))
			Else
			...
			If (Original_ReorderLevel.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(24).Value = (CShort(Fix(Original_ReorderLevel.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(23).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(24).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(25).Value = (CBool(Original_Discontinued))
			Me.Adapter.UpdateCommand.Parameters(26).Value = (CInt(Fix(ProductID)))
			Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
			If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open) <> Global.System.Data.ConnectionState.Open) Then
				Me.Adapter.UpdateCommand.Connection.Open()
			End If
